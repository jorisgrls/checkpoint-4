...
function DeleteCategoryConfirm({ showDeleteModal, onCloseModal, id }) {
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Êtes-vous sûr de vouloir supprimer l'annonce ? Vous ne
                      pourrez pas revenir en arrière après cette action.
                    </p>
                  </div>
                </div>
              </div>
